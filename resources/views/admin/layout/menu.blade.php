<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside" style="overflow: hidden;">
    ...
    <!-- begin:: Aside -->
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand" kt-hidden-height="65" style="background: #eff4f8fa;">
        <div class="kt-aside__brand-logo">
            <a href="#">
            <img alt="Logo" src="{{ asset('./assets/imgs/logo_s.png') }}" style="width: 80%;margin: auto;display: block;text-align: center;">
            </a>
        </div>
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        ...
        <ul class="kt-menu__nav ">
            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.account-admin.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    ...
                    </span><span class="kt-menu__link-text">Tài khoản Admin</span>
                </a>
            </li>

            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.account.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <polygon points="0 0 24 0 24 24 0 24"/>
                        <path d="M18,14 C16.3431458,14 15,12.6568542 15,11 C15,9.34314575 16.3431458,8 18,8 C19.6568542,8 21,9.34314575 21,11 C21,12.6568542 19.6568542,14 18,14 Z M9,11 C6.790861,11 5,9.209139 5,7 C5,4.790861 6.790861,3 9,3 C11.209139,3 13,4.790861 13,7 C13,9.209139 11.209139,11 9,11 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                    ...
                    </span><span class="kt-menu__link-text">Tài khoản khách hàng</span>
                </a>
            </li>
            

            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.product.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                  <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Box2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    </span><span class="kt-menu__link-text">Sản phẩm</span>
                </a>
            </li>

            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.category.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                  <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Layout\Layout-grid.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24"/>
                    ...
                    </span><span class="kt-menu__link-text">Tab Bảng Giá</span>
                </a>
            </li>


             <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.price-list.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                  <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Layout\Layout-top-panel-6.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    </span><span class="kt-menu__link-text">Bảng giá dịch vụ</span>
                </a>
            </li>

             <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.try-product.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    ...
                    </span><span class="kt-menu__link-text">Sản phẩm KH đăng ký</span>
                </a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.try-service.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Design\Layers.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <polygon points="0 0 24 0 24 24 0 24"/>
                            <path d="M12.9336061,16.072447 L19.36,10.9564761 L19.5181585,10.8312381 C20.1676248,10.3169571 20.2772143,9.3735535 19.7629333,8.72408713 C19.6917232,8.63415859 19.6104327,8.55269514 19.5206557,8.48129411 L12.9336854,3.24257445 C12.3871201,2.80788259 11.6128799,2.80788259 11.0663146,3.24257445 L4.47482784,8.48488609 C3.82645598,9.00054628 3.71887192,9.94418071 4.23453211,10.5925526 C4.30500305,10.6811601 4.38527899,10.7615046 4.47382636,10.8320511 L4.63,10.9564761 L11.0659024,16.0730648 C11.6126744,16.5077525 12.3871218,16.5074963 12.9336061,16.072447 Z" fill="#000000" fill-rule="nonzero"/>
                    ...
                    </span><span class="kt-menu__link-text">Đăng ký dùng thử dịch vụ</span>
                </a>
            </li>

                        
            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.contact.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                   <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Contact1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    </span><span class="kt-menu__link-text">Tư vấn khách hàng</span>
                </a>
            </li>

{{-- 
            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.node.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <polygon points="0 0 24 0 24 24 0 24"/>
                    ...
                    </span><span class="kt-menu__link-text">Nodes</span>
                </a>
            </li>

            <li class="kt-menu__item " aria-haspopup="true">
                <a href="{{ route('admin.release-node.index') }}" class="kt-menu__link "><span class="kt-menu__link-icon">
                    ...
                    </span><span class="kt-menu__link-text">Release Nodes</span>
                </a>
            </li> --}}
        </ul>
