                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{ route('admin.node.create-node') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                ...
                                <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                    ...
                                    <td data-autohide-disabled="false" class="kt-datatable__cell">
                                        <span style="overflow: visible; position: relative; width: 110px;"> 
                                            <a href="{{ route('admin.node.edit-node', $item->id ) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">              
                                            ...
                                            <div class="modal fade" id="modal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <a href="{{ route('admin.node.delete-node', $item->id) }}" class="btn btn-danger">Xóa</a>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
