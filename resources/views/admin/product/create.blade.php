            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <h3 class="kt-portlet__head-title">Thêm sản phẩm</h3>
                        </div>
                    </div>
                    </div>
                    ...
                    <!-- /.col -->
                        <div class="col-md-12">
                            <div class="nav-tabs-custom" style="padding: 30px">
                                ...
                                @endif
                                <form class="form-horizontal form-profile" method="POST" action="{{ route('admin.product.save-product') }}" enctype="multipart/form-data">
                                    @csrf
