                        ...
                        <thead class="kt-datatable__head">
                            ...
                            <th class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 100px;">Nghề nghiệp</span></th>
                             <th class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 100px;">Doanh nghiệp</span></th>
                              ...
                              <th class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 100px;">Sản phẩm</span></th>
                             <th class="kt-datatable__cell kt-datatable__cell--sort"><span style="width: 100px;">Hành động</span></th>
                            </tr>
                        </thead>
                        <tbody class="kt-datatable__body" style="">
                            @foreach ($try_product as $key => $item)
                                <tr data-row="0" class="kt-datatable__row" style="left: 0px;">
                                  ...
                                  <td data-autohide-disabled="false" class="kt-datatable__cell">
                                        <span style="overflow: visible; position: relative; width: 110px;">
                                            <a href="{{ route('admin.try-product.view-try-product', $item->id ) }}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View details">
                                                <i class="la la-eye"></i>
                                            </a>
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <a href="{{ route('admin.try-product.delete-try-product', $item->id) }}" class="btn btn-danger">Xóa</a>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
