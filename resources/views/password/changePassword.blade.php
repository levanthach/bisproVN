    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center">
        <div class="col-md-6 intro-info order-md-first order-last">
          <h2>Đặt lại<span> Password</span></h2>
          <div class="limiter">
            <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
                ...
                @if(count($errors) > 0)
                    ...
                    @endforeach
                @endif
              <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="width: 1000px">
                <form class="login100-form validate-form" method="POST" action="{{ route('password.update-password', $forgot->token) }}">
                  @csrf
                  <div class="wrap-input100 validate-input m-b-23" data-validate = "Email is required">
                    <span class="label-input100">Email</span>
                    <input readonly class="input100" type="email" name="email" placeholder="Nhập địa chỉ email" value="{{ $forgot->email }}" required>
                  ...
                  <div class="wrap-input100 validate-input" data-validate="Password is required">
                    ...
                    <input class="input100" type="password" name="confirmPassword" placeholder="Nhập lại mật khẩu mới">
                    <span class="focus-input100" data-symbol="&#xf190;"></span>
                  </div>
                  <br>
